...
const PopupWidget = () => {
  ...
  const userName = useWatch({ control, name: "Nome", defaultValue: "Alguém" });
        ...
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-indigo-500 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-indigo-600 focus:bg-indigo-600 ease">
              <span className="sr-only">Abrir Janela de Contato</span>
              <Transition
                show={!open}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          placeholder="inovarclimatizacaomt@gmail.com"
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.email
                              ? "border-red-600 focus:border-red-600 ring-red-100"
                              : "border-gray-300 focus:border-indigo-600 ring-indigo-100"
